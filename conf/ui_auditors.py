"""Defines the UI for the tab "Auditors"."""
...
def add_people(lst, doc_id, people):
    """Adds a the arguments to construct a line given later to src.ui.tab.parseLst"""
